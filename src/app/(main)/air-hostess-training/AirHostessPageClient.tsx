      ...
      <section className="px-6 mb-16 lg:mb-20 relative">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 animate-fade-in-up [animation-delay:600ms]">
             <div className="glass-panel p-6 rounded-2xl flex items-center gap-4 border-l-4 border-wings-red">
      ...
      <section className="px-6 mb-16 lg:mb-24">
         <div className="max-w-7xl mx-auto">
            ...
            <div className="text-center mt-12">
               ...
               <Link 
                  href="/placements"
                  className="inline-flex items-center gap-2 px-8 py-4 glass-panel rounded-full text-zinc-900 dark:text-white font-bold hover:bg-white/50 dark:hover:bg-white/10 transition-all border border-zinc-200 dark:border-white/10 leading-[1.3]"
               >
