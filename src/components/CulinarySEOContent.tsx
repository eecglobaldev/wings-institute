...
export function CulinarySEOContent() {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      const handleBeforeUnload = () => {
        ...
        sessionStorage.setItem('seo-scroll-culinary', String(scrollPosition));
      };
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      const storageKey = 'seo-expanded-culinary';
      const scrollKey = 'seo-scroll-culinary';
      ...
      if (savedState === 'true' || urlHash === '#seo-content') {
        ...
        setTimeout(() => {
          if (savedScroll) {
            ...
            const section = document.getElementById('culinary-seo-content');
            if (section) {
